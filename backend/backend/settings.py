...
# Backend verifier keypair — registered on-chain via scripts/register_verifier.ts
# Signs verify_skill transactions; minter wallet pays all fees
SOLANA_VERIFIER_KEY = os.getenv('SOLANA_VERIFIER_KEY', '')
